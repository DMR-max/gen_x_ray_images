...
class Encoder(nn.Module):
    # Initialize the class
    def __init__(self, dimensions_input, dimensions_hidden, dimensions_latent):
        ...
        self.layer2 = nn.Linear(dimensions_hidden, dimensions_hidden)
        self.layer3 = nn.Linear(dimensions_hidden, dimensions_hidden)
        self.layer4 = nn.Linear(dimensions_hidden, dimensions_hidden)
        # Set the mean layer
    ...
    def forward(self, x):
        ...
        # Set the hidden layers
        layer_       = self.LeakyReLU(self.layer2(layer_))
        layer_       = self.LeakyReLU(self.layer3(layer_))
        layer_       = self.LeakyReLU(self.layer4(layer_))
...
class Decoder(nn.Module):
    # Initialize the class
    def __init__(self, dimensions_latent, dimensions_hidden, output_dimensions):
        # Initialize the superclass
        nn.Module.__init__(self)
        # Set the input layer
    ...
    def forward(self, input):
        ...
        # Set the hidden layers
        layer     = self.LeakyReLU(self.layer2(layer))
        layer     = self.LeakyReLU(self.layer3(layer))
        layer     = self.LeakyReLU(self.layer4(layer))
        # Set the output layer
...
class training():
    ...
    # Check if the dataset is the NIH dataset
    # path = input("Please select the path where the images and model saves should be stored")
    ...
    # location_of_txt_file_test =input("the location of the training txt files") 
    path = input("Please select the path where the images and model saves should be stored")
    directory_of_images = input("Please select the directory of images")
    location_of_txt_file_train = input("the location of the training txt files")
        ...
        for lr in lr_list:
            ...
            for hidden_dim in hidden_dim_list:
                ...
                def loss_function(x, x_hat, mean, log_var):
                    ...
                    Kullback = - 0.5 * torch.sum(1+ log_var - mean.pow(2) - log_var.exp())

                    # Return the reproduction loss and KLD
                    return loss + Kullback
                ...
                for epoch in range(epochs):
                    ...
                    for index, batch in enumerate(loader_train):
                        ...
                        loss_between_distribs = loss_function(batch, output, average, log_variance).to(DEVICE)
